...
/**
  ...
  * @var \App\Model\Entity\Ticketimpact $ticketimpact
  */
?>

<div class="ticketimpacts view">
    <h3><?= h($ticketimpact->name) ?></h3>
	<div class="actions">
		<ul>
			<li><?= $this->Form->postLink(__('Delete Ticketimpact'), ['action' => 'delete', $ticketimpact->id], ['confirm' => __('Are you sure you want to delete # {0}?', $ticketimpact->id)]) ?> </li>
			<li><?= $this->Html->link(__('New Ticketimpact'), ['action' => 'add']) ?> </li>
			<li><?= $this->Html->link(__('List Ticketimpacts'), ['action' => 'index']) ?> </li>
			<li><?= $this->Html->link(__('Edit Ticketimpact'), ['action' => 'edit', $ticketimpact->id]) ?> </li>
		</ul>
	</div>
	<div class="viewdata">
...
<div class="easyui-tabs">
    <div class="related" title="<?= __('Tickets') ?>">
        ...
        <?php if (!empty($ticketimpact->tickets)): ?>
        <table cellpadding="0" cellspacing="0">
		  ...
		  <tbody>
            <?php foreach ($ticketimpact->tickets as $tickets): ?>
            <tr>
                <td><?= h($tickets->id) ?></td>
