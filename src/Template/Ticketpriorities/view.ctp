...
<div class="ticketpriorities view">
    <h3><?= h($ticketpriority->name) ?></h3>
	<div class="actions">
		<ul>
			<li><?= $this->Form->postLink(__('Delete Ticketpriority'), ['action' => 'delete', $ticketpriority->id], ['confirm' => __('Are you sure you want to delete # {0}?', $ticketpriority->id)]) ?> </li>
			<li><?= $this->Html->link(__('New Ticketpriority'), ['action' => 'add']) ?> </li>
			<li><?= $this->Html->link(__('List Ticketpriorities'), ['action' => 'index']) ?> </li>
			<li><?= $this->Html->link(__('Edit Ticketpriority'), ['action' => 'edit', $ticketpriority->id]) ?> </li>
		</ul>
	</div>
	<div class="viewdata">
