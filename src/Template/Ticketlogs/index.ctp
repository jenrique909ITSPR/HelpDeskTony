...
/**
  ...
  * @var \App\Model\Entity\Ticketlog[]|\Cake\Collection\CollectionInterface $ticketlogs
  */
?>

<div class="ticketlogs index">
    <h3><?= __('Ticketlogs') ?></h3>
	<div class="actions">
		<ul>
    ...
    <table cellpadding="0" cellspacing="0">
        <thead>
            <tr>
                ...
                <th scope="col"><?= $this->Paginator->sort('user_transfer') ?></th>
                <th scope="col"><?= $this->Paginator->sort('group_transfer') ?></th>
